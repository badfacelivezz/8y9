local Library = {}
Library.SetOpenButtonImage = 13212426934
...
function Library:Window(Args)
    local Title = Args.Title or "8y9 Script"
    local SubTitle = Args.SubTitle or "8y9 Library"
    ...
    local Destroy = Library:Create("Frame", {
        Name = "Destroy",
        Parent = HeadScale_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Asset_1 = Library:Create("ImageButton", {
        Name = "Asset",
        Parent = Destroy,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
        ...
        Image = "rbxassetid://11464213545",
        ImageColor3 = Color3.fromRGB(255, 255, 255),
        LayoutOrder = 1
    })
        Asset_1.MouseButton1Click:Connect(function()
        Xova:Destroy()
    end)
    Library:Create("UIGradient", {
        Parent = Asset_1,
    ...
    function Window:NewPage(Args)
        ...
        local Banner = Args.Image or 125411502674016
    ...
    do
        ...
        do
            ...
            Library:Create("ImageLabel", {
                ...
                ScaleType = Enum.ScaleType.Crop,
                Size = UDim2.new(0, 50, 0, 50),
                Image = Library:Asset(Library.SetOpenButtonImage or 106718938711987)
            })
            Library:Create("UIStroke", {
                Parent = Logo,
